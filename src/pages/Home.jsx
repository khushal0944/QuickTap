...
import { House, Pencil, Play, Save, Trash, User, Volume2, VolumeX } from 'lucide-react';
import { changeMuted } from "../slices/muteAudioSlice";
    ...
    return (
        <div className="w-full min-h-screen max-h-fit flex dark:bg-gray-950 justify-center bg-pink-100">
            ...
            >
                <button
                    onClick={toggleMute}
                    className={`relative p-2 rounded-full transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg ${
                        isMuted
